...
export const loadCaj = async (filePath, context) => {
...
async function convertCajToPdf(filePath, buffer, cajFormat, warnings) {
...
async function runExternalCaj2Pdf(command, filePath, warnings) {
...
async function copyOptionalCajLibraries(tempDir) {
...
async function convertKdh(buffer, warnings) {
...
function detectCajFormat(buffer) {
...
function extractOutline(buffer, cajFormat, warnings) {
