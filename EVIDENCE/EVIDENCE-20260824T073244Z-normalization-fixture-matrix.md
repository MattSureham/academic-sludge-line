...
- **Supersedes / superseded by:** Adds representative evidence to [`EVIDENCE-20260824T024051Z-spec-reconciliation`](EVIDENCE-20260824T024051Z-spec-reconciliation.md); it does not supersede its unrelated classifications. Its image-only-PDF warning-gap observation is superseded for the later approved state by [`EVIDENCE-20260824T080248Z-pdf-marker-only-warning`](EVIDENCE-20260824T080248Z-pdf-marker-only-warning.md). Its invalid-UTF-8/NUL warning-gap observation is superseded for the later approved state by [`EVIDENCE-20260825T024729Z-invalid-utf8-nul-warning`](EVIDENCE-20260825T024729Z-invalid-utf8-nul-warning.md). Its unsupported-directory omission observation is superseded for the later candidate state by [`EVIDENCE-20260826T033558Z-directory-unsupported-reporting`](EVIDENCE-20260826T033558Z-directory-unsupported-reporting.md). All original observations remain valid at this record's captured revision.
